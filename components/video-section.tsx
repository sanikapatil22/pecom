...
export default function VideoSection({
  ...
  const handleModalOpen = () => {
    setIsModalOpen(true);
    // Sync modal video with card video time and play
    if (modalVideoRef.current && cardVideoRef.current) {
    ...
    <>
      ...
      >
        <CardContent className="p-0">
          <div className="relative w-full pb-[140%] overflow-hidden bg-gray-100">
            <video
              ref={cardVideoRef}
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    {discountPercentage > 0 && (
                      <>
                        ...
                        <span className="text-[#37BD6B] text-base lg:text-lg font-medium">
                          {discountPercentage}% OFF
                        </span>
                      </>
                    )}
